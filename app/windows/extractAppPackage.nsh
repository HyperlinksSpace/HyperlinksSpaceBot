...
; Phase progress: HspInstallProgressSet (installer-hooks.nsi) at decompress / post-extract / copy done.
...
!macro extractUsing7za FILE
  ...
  Pop $R0
  SetOutPath $R0
  !insertmacro HspInstallProgressSet 55
